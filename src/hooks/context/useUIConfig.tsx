...
export const useUIConfig = () => {
  ...
  useEffect(() => {
    ...
    const fontSizeKey: FontSizeKey = validFontSizes.includes(defaultFontSize as FontSizeKey) ? defaultFontSize as FontSizeKey : 50 as FontSizeKey;
    ...
    uiValues.setUiFontFamily({ name: defaultFontFamily, fontFamily: fonts[defaultFontFamily as FontKeys] });
