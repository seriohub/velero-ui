...
import { Menu, rem, Center, Group, Switch } from '@mantine/core';
import {
  IconSettings,
  IconMessageCircle,
  IconChevronDown,
            ...
            <Group>
              <div>
                <Text
                  fw={500}
                  c="primary"
                >{`${userValues.user?.username}`/*`${userValues.user?.firstname} ${userValues.user?.lastname}`*/}</Text>
                <Text size="xs" c="dimmed">
                  {userValues.user?.email}
                </Text>
              </div>
