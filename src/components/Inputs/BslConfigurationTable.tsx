...
import { BslConfigurationField } from '@/components/Inputs/BslConfigurationField';
...
export default function BslConfigurationTable({ config, setConfig }: BslConfigurationTableProps) {
    ...
    <Table.Tr key={element.key}>
      ...
      <Table.Td>
        <Tooltip label="Delete">
          <ActionIcon size="sm" variant="transparent" onClick={() => handleRemoveRow(element.key)}>
