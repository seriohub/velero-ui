...
import { ActionIcon, Group, MultiSelect, Text, Loader, Center, Alert } from '@mantine/core';
...
export function LogsTable({ items = [], fetching, error }: LogsProps) {
            ...
            render: ({ level }) => {
              if (level === 'info') {
                return (
                  <>
                    <Group gap={3}>
                      <ActionIcon size={20} variant="outline" color="blue">
                        <IconInfoCircle />
                      </ActionIcon>
                      {level}
                    </Group>
              ...
              if (level === 'warning') {
                return (
                  <>
                    <Group gap={3}>
                      <ActionIcon size={20} variant="outline" color="yellow">
                        <IconAlertTriangle />
                      </ActionIcon>
                      {level}
                    </Group>
              ...
              if (level === 'error') {
                return (
                  <>
                    <Group>
                      <ActionIcon size={20} variant="outline" color="red">
                        <IconAlertTriangle />
                      </ActionIcon>
                      {level}
                    </Group>
